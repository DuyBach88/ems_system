    ...
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Employee Profile</h1>
            <p className="text-gray-600">Comprehensive employee information and details</p>
          </div>
          <button
        ...
        <div className="bg-gradient-to-r from-teal-600 to-green-600 px-8 py-12 relative">
          <div className="flex items-center space-x-8">
            ...
            <div className="flex-1 text-white">
              <h2 className="text-4xl font-bold mb-2">{employee.userId?.name || "N/A"}</h2>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors duration-200">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-semibold text-gray-800">{employee.userId?.name || "N/A"}</span>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors duration-200">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-semibold text-gray-800">{employee.userId?.email || "N/A"}</span>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors duration-200">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-gray-500 uppercase tracking-wide">Gender</span>
                    <span className="text-lg font-semibold text-gray-800">{employee.gender || "N/A"}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-teal-50 to-green-50 rounded-xl p-6 border border-teal-200">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-teal-700 uppercase tracking-wide">Employee ID</span>
                    <span className="text-2xl font-bold text-teal-800">{employee.employeeId || "N/A"}</span>
                  </div>
                </div>

                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-green-700 uppercase tracking-wide">Department</span>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-200">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-blue-700 uppercase tracking-wide">Status</span>
                    <div className="flex items-center space-x-2">
                      <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                      <span className="text-xl font-bold text-blue-800">Active</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 hover:border-teal-200">
          ...
          <h4 className="text-lg font-semibold text-gray-800 mb-2">Account Status</h4>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 hover:border-green-200">
          ...
          <h4 className="text-lg font-semibold text-gray-800 mb-2">Join Date</h4>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 hover:border-blue-200">
          ...
          <h4 className="text-lg font-semibold text-gray-800 mb-2">Profile Score</h4>
